...
def test_generate_radicals():
    ...
    radicals = generate_radicals(species=T3Species(label='H', smiles='[H]'),
                                 types=['radical', 'alkoxyl', 'peroxyl'],
                                 )
    assert radicals == list()

    # test CO, should not give any radicals
    radicals = generate_radicals(species=T3Species(label='CO', smiles='[C-]#[O+]'),
                                 types=['radical', 'alkoxyl', 'peroxyl'],
                                 )
    assert radicals == list()

    # test CH4, should only give 3 radicals, one of each type
    radicals = generate_radicals(species=T3Species(label='CH4', smiles='C'),
                                 types=['radical', 'alkoxyl', 'peroxyl'],
                                 )
    ...
    # test ethylamine
    radicals = generate_radicals(species=T3Species(label='ethylamine', smiles='NCC'),
                                 types=['radical', 'alkoxyl', 'peroxyl'],
                                 )
    ...
    # test benzyl alcohol
    radicals = generate_radicals(species=T3Species(label='benzyl_alcohol', smiles='c1ccccc1CO'),
                                 types=['radical', 'alkoxyl', 'peroxyl'],
                                 )
    ...
    expected_radicals = [('benzyl_alcohol_peroxyl_0', '[O]Oc1ccccc1CO'),
                         ('benzyl_alcohol_peroxyl_1', '[O]Oc1cccc(CO)c1'),
                         ('benzyl_alcohol_peroxyl_2', '[O]Oc1ccc(CO)cc1'),
                         ('benzyl_alcohol_peroxyl_5', '[O]OC(O)c1ccccc1'),
                         ('benzyl_alcohol_peroxyl_6', '[O]OOCc1ccccc1')]
    check_expected_generated_radicals(radicals, expected_radicals)
