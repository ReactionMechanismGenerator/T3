...
class RMSConstantV(SimulateAdapter):
    """
    RMSConstantV is an adapter for the abstract class SimulateAdapter that runs homogeneous gas reactions
    ...
    def set_up(self):
        ...
        domain, y0, p = rms.ConstantVDomain(phase=self.phase, initialconds=self.initialconds)
...
register_simulate_adapter("RMSConstantV", RMSConstantV)
