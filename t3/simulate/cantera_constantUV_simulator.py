...
class CanteraSimulatorConstantUV(SimulateAdapter):
    """
    CanteraSimulatorConstantUV is an adapter for the abstract class SimulateAdapter that simulates ideal gases
    ...
    def simulate(self):
        ...
        self.logger.info('Simulating a job using Cantera...')
...
register_simulate_adapter("CanteraSimulatorConstantUV", CanteraSimulatorConstantUV)
