...
class CanteraSimulatorConstantTP(SimulateAdapter):
    """
    CanteraSimulatorConstantTP is an adapter for the abstract class SimulateAdapter that simulates ideal gases
...
register_simulate_adapter("CanteraSimulatorConstantTP", CanteraSimulatorConstantTP)
