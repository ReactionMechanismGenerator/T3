...
"""
t3 tests test_cantera_constantUV_simulator module
"""
...
from t3.simulate.cantera_constantUV_simulator import CanteraSimulatorConstantUV
...
def test_set_up_no_sa():
    ...
    t3.set_paths()
    cantera_simulator_adapter = CanteraSimulatorConstantUV(t3=t3.t3,
                                                           rmg=t3.rmg,
                                                           paths=t3.paths,
                                                           logger=t3.logger,
