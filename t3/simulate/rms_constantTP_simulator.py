...
class RMSSimulatorConstantTP(SimulateAdapter):
    """
    RMSSimulatorConstantTP is an adapter for the abstract class SimulateAdapter that simulates ideal gases
...
register_simulate_adapter("RMSSimulatorConstantTP", RMSSimulatorConstantTP)
