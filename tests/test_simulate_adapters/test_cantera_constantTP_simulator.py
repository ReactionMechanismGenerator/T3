...
"""
t3 tests test_cantera_constantTP_simulator module
"""
...
from t3.simulate.cantera_constantTP_simulator import CanteraSimulatorConstantTP
...
def test_set_up_no_sa():
    ...
    t3.set_paths()
    cantera_simulator_adapter = CanteraSimulatorConstantTP(t3=t3.t3,
                                                           rmg=t3.rmg,
                                                           paths=t3.paths,
                                                           logger=t3.logger,
