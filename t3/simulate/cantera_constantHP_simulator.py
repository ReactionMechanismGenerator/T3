...
class CanteraSimulatorConstantHP(SimulateAdapter):
    """
    CanteraSimulatorConstantHP is an adapter for the abstract class SimulateAdapter that simulates ideal gases
...
register_simulate_adapter("CanteraSimulatorConstantHP", CanteraSimulatorConstantHP)
