...
class RMGSimulatorConstantTP(SimulateAdapter):
    """
    RMGSimulatorConstantTP is an adapter for the abstract class SimulateAdapter that simulates mechanisms in a homogenous,
    ...
    def set_up(self):
        ...
        if len(self.observable_list):
            self.logger.info('Running SA using RMG...')
    ...
    def simulate(self):
        ...
        """
        self.logger.info('Simulating a job using RMG...')
...
register_simulate_adapter("RMGSimulatorConstantTP", RMGSimulatorConstantTP)
