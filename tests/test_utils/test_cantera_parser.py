...
def test_load_species_thermo_comments():
    ...
    for species in species_list:
        print(f'label: {species.label}, thermo_method: {species.thermo_method}, thermo_source: {species.thermo_source}, thermo_comment: {species.thermo_comment}')
        if species.label == 'H2(1)':
            print(f"Species: {species.label}, Thermo Method: {species.thermo_method}, Thermo Source: {species.thermo_source}, Thermo Comment: {species.thermo_comment}")
