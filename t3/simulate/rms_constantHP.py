...
class RMSConstantHP(SimulateAdapter):
    """
    RMSConstantHP is an adapter for the abstract class SimulateAdapter that simulates ideal gases
    ...
    def simulate(self):
        ...
        if len(self.observable_list):
            ...
            self.logger.info('Running a simulation using RMSConstantHP...')
...
register_simulate_adapter("RMSConstantHP", RMSConstantHP)
