...
"""
t3 tests test_rms_constantUV_simulator module
"""
...
from t3.simulate.rms_constantUV_simulator import RMSSimulatorConstantUV
...
def test_set_up_no_sa():
    ...
    rms_simulator_adapter = RMSSimulatorConstantUV(t3=t3.t3,
                                                   rmg=t3.rmg,
                                                   paths=t3.paths,
                                                   logger=t3.logger,
