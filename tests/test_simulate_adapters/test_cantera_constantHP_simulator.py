...
"""
t3 tests test_cantera_constantHP_simulator module
"""
...
from t3.simulate.cantera_constantHP_simulator import CanteraSimulatorConstantHP
...
def test_set_up_no_sa():
    ...
    t3.set_paths()
    cantera_simulator_adapter = CanteraSimulatorConstantHP(t3=t3.t3,
                                                           rmg=t3.rmg,
                                                           paths=t3.paths,
                                                           logger=t3.logger,
