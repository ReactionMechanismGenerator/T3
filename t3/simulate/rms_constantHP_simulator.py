...
Used to run mechanism analysis with RMS as an ideal gas in a batch reactor at constant H-P
"""
...
class RMSSimulatorConstantHP(SimulateAdapter):
    """
    RMSSimulatorConstantHP is an adapter for the abstract class SimulateAdapter that simulates ideal gases
    ...
    def set_up(self):
        ...
        self.domain, self.y0, self.p = rms.ConstantPDomain(phase=self.phase,
...
register_simulate_adapter("RMSSimulatorConstantHP", RMSSimulatorConstantHP)
